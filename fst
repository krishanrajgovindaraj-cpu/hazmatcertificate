...
<h1 style="color:#ED7C31;">FOOD SAFETY TRANING</h1>
...
<div id="certificate" class="certificate">
  ...
  <div style="text-align:center; margin-top:20px;">
    ...
    <p><strong>Aneja Towers, B Block 4th Floor,<br>Perungudi, Chennai – 600096</strong></p>
  </div>
<br>
...
<br>
  <h2 style="text-align:center;">FOOD SAFETY TRAINING</h2>
  ...
  <ul style="font-size:14px; line-height:2.1;">
    <li>Requirement of ILO guidelines for training of Ship Cook</li>
    <li>Why Food Safety is required</li>
    <li>What steps are to be taken to achieve the Food safety </li>
    <li>Safe Galley procedures</li>
...
<!-- Revision -->
<p style="position:absolute; bottom:10px; right:40px; font-size:11px;">
Rev No 00/2026/11-03-2026
</p>
</div>
<script>

const SHEET_URL = "https://script.google.com/macros/s/AKfycbzSr03P0DwEOqcOi_ZVx4oc5uxzaJGhfe3WiKG1LrQMAJrmK0G6Hgfls_lGw0iaCNdE9A/exec";

const STORAGE_KEY_COUNT = "certCount_FST";
const STORAGE_KEY_LIST = "certificateList_FST";

let certCount = 0;
let certificateList = [];

/* ============================= */
/* PAGE LOAD - VERY IMPORTANT */
/* ============================= */

window.onload = function () {

  certCount = Number(localStorage.getItem(STORAGE_KEY_COUNT)) || 0;
  certificateList = JSON.parse(localStorage.getItem(STORAGE_KEY_LIST)) || [];
...
function resetCounter(){
  ...
  if(confirm("Reset certificate count?")){
